...
public class Fp04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(verilenIkiSayiArasindakiCiftSayilarinToplami(10, 5));
    ...
    public static int get7den100eToplam() {
        ...
        return IntStream.range(7, 101).reduce(Math::addExact).getAsInt(); // 101 yazdık çünkü sondan bir öncekini alıyor substring gibi
    }

    //2.Yol:
    public static int get7den100eToplam02() {

        return IntStream.rangeClosed(7, 100).reduce(Math::addExact).getAsInt(); // 101 yazdık çünkü sondan bir öncekini alıyor substring gibi
    }
