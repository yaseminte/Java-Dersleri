...
public class C03_Update {
    public static void main(String[] args) {
        ...
        System.out.println(sinifListMap.containsValue("JDev")); // false ==> bir parcayi kontrol edemeyiz

        // Verilen map'de JDev degerlerini JavaDeveloper olarak degidtirelim
