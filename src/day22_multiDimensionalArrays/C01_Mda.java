...
public class C01_Mda {
    public static void main(String[] args) {
        ...
        int [][] sayilar ={{1,2,3,4,5},{3,4}};
        2- outer ve inner array'lerin uzunluklarini belirtierek olusturabiliriz
        ...
        eger inner array'leri farkli uzunluklarda olusturmak istiyorsaniz
