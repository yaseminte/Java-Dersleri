...
public class C01 {
    ...
    public static void main(String[] args) {
        ...
        herhangi bir satirda instance variable'in degerinin ne oldugunu bulma icin
        ...
        CLASS'IN BASINDAN ititbaren kod incelenmelidir.
        ...
        // sayi variable'i static oldugu icin direk yazdirabiliriz ama hocamız obje konusunu anlamamiz icin
        // sayi variable'ini obje uzerinden cagirdi. Uzeri o yüzden sarardi :)

        obj1.rakam+=1; // 5 + 1 = 6
        obj1.sayi+=1; // 10 + 1 = 11 --> sayi+=1; bu sekilde de yazilir cünkü sayi variable!i static'tir
