...
public class C03_RakamlarToplami {
    public static void main(String[] args) {
        ...
        System.out.print("Lutfen dort basamakli pozitif bir tamsayi giriniz : ");
