...
public class C05_StringVsStringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println("String zaman : " + (bitis.getNano()-baslangic.getNano())); // 16250200
        ...
        System.out.println("String Builder zaman : " + (bitis.getNano()-baslangic.getNano())); // 16250200
    }
}
